...
namespace Assignment24_Program
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            using (FileStream fileStream = new FileStream("D:\\assignemt exercise\\Assignment-24\\employee.xml", FileMode.Create))
            {
                xmlSerializer.Serialize(fileStream, employee);
            }
            using (FileStream fileStream = new FileStream("D:\\assignemt exercise\\Assignment-24\\employee.xml", FileMode.Open))
            {
